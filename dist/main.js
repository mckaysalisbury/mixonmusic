...
class Slideshow {
    constructor(container, sources, intervalMs = 7000, dissolveMs = 1300) {
        this.container = container;
        this.sources = sources;
        this.intervalMs = intervalMs;
        this.dissolveMs = dissolveMs;
        this.timerId = null;
        this.index = 0;
        if (sources.length === 0) {
...
const contactMenuMarkup = (option) => {
...
const initFlyout = (flyoutId, toggleId) => {
